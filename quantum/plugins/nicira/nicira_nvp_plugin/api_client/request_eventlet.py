...
from request import (NvpApiRequest, DEFAULT_REQUEST_TIMEOUT,
                     DEFAULT_HTTP_TIMEOUT, DEFAULT_RETRIES, DEFAULT_REDIRECTS,
                     DEFAULT_API_REQUEST_POOL_SIZE, DEFAULT_MAXIMUM_REQUEST_ID)
...
class NvpApiRequestEventlet(NvpApiRequest):
